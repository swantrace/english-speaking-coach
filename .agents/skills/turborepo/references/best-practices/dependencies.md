...
pnpm add react --filter=@english-coach/ui
...
```bash
# pnpm
pnpm add lodash --filter=@english-coach/utils

# npm
npm install lodash --workspace=@english-coach/utils

# yarn
yarn workspace @english-coach/utils add lodash
...
```bash
# pnpm
pnpm add jest --save-dev --filter=web --filter=@english-coach/ui

# npm
npm install jest --save-dev --workspace=web --workspace=@english-coach/ui

# yarn (v2+)
yarn workspaces foreach -R --from '{web,@english-coach/ui}' add jest --dev
```
...
```bash
# pnpm
pnpm add @english-coach/ui --filter=web

# This updates package.json:
{
  "dependencies": {
    "@english-coach/ui": "workspace:*"
  }
}
```
