...
```json
{
  "name": "@english-coach/ui", // Unique, namespaced name
...
{
  "extends": "@english-coach/typescript-config/library.json",
  "compilerOptions": {
    "outDir": "dist",
    "rootDir": "src"
  },
...
{
  "name": "@english-coach/eslint-config",
  "exports": {
    "./base": "./base.js",
    "./next": "./next.js",
    "./library": "./library.js"
...
module.exports = {
  extends: ["@english-coach/eslint-config/next"]
};
```
