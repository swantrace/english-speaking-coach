import { buildJsonOutputConstraints, formatKnowledgePointTypesAndTags } from "../helper";
import {
...
export function buildKnowledgePointGeneratePrompt(params: BuildKnowledgePointGeneratePromptParams) {
...
You must follow the controlled grammar tag inventory provided in the instructions.`;
	...
	const { formattedTypes, formattedGrammarTags, formattedFunctionalTags } = formatKnowledgePointTypesAndTags(
		knowledgePointTypes,
		grammarTags,
		functionalTags,
	);
