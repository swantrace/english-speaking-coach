import { z } from "zod";
import { KNOWLEDGE_POINT_TYPES, type KnowledgePointType } from "../../db/constants";
 ...
 */
export const knowledgePointTypes = KNOWLEDGE_POINT_TYPES;
 ...
 */
export const KnowledgePointGenerateSchema = z.object({
	...
	type: z.enum(knowledgePointTypes),
...
export type KnowledgePointGenerateResult = z.infer<typeof KnowledgePointGenerateSchema>;

export type BuildKnowledgePointGeneratePromptParams = {
	provider: ProviderId;
	draftPhrase: string;
