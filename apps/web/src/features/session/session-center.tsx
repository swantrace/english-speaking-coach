        ...
        <div className="grid gap-3">
          ...
          <div className="grid gap-2 md:grid-cols-[minmax(0,1fr)_18rem] md:items-start">
            <div className="grid gap-2">
              <h1 className="text-3xl text-slate-950 sm:text-4xl">Room {roomName}</h1>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_20rem] xl:items-start">
        <Card className="grid gap-4 p-5">
          <div className="flex items-center justify-between gap-4">
            <h2 className="text-lg text-slate-950">Steer the session</h2>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3">
              <TrackToggle
                className="rounded-full border border-slate-200 bg-white px-4 py-2 text-sm text-slate-900 transition hover:border-cyan-300/40"
            ...
            <div className="grid gap-3 md:grid-cols-[1fr_auto] md:items-end">
              <label className="grid gap-2 text-sm text-slate-700">
                ...
                <textarea
                  className="min-h-24 rounded-[18px] border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-cyan-300/40"
        ...
        <Card className="grid gap-4 p-5">
          <div className="flex items-center justify-between gap-4">
            <h2 className="text-lg text-slate-950">Agent voice</h2>
          ...
          <div className="grid min-h-48 place-items-center rounded-[22px] border border-orange-300/15 bg-orange-300/10 p-6">
            {microphoneTrack ? (
              ...
              <span className="text-sm text-slate-600">Waiting for the agent audio track...</span>
            )}
          </div>
          <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-4 text-sm leading-7 text-slate-600">
