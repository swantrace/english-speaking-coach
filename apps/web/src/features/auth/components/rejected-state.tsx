      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm leading-6 text-slate-600">
            If this looks unexpected, please contact the team that manages approvals. If your status changes later, the
            same centralized auth logic will route you to the right place automatically.
          </p>
        </div>
        <Button
