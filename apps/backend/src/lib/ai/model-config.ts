...
export const modelConfig: Record<ProviderId, AiModelConfig> = {
  openai: {
    ...
    CONVERSATION_ANALYSIS_MODEL: providerModelEnv("openai", "CONVERSATION_ANALYSIS_MODEL", "gpt-4o"),
  },
  qwen: {
    ...
    CONVERSATION_ANALYSIS_MODEL: providerModelEnv("qwen", "CONVERSATION_ANALYSIS_MODEL", "qwen-2.2-mini"),
  },
};
